...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">{{ __('admin.create_page') }}</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-1">{{ __('admin.create_new_dynamic_page') }}</p>
            </div>
    ...
    <form action="{{ route('admin.pages.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                ...
                <div>
                    ...
                    <textarea id="description_en" name="description_en" rows="3"
                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                              placeholder="{{ __('admin.enter_page_description_english') }}">{{ old('description_en') }}</textarea>
                ...
                <div>
                    ...
                    <textarea id="description_ar" name="description_ar" rows="3" dir="rtl"
                              class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                              placeholder="{{ __('admin.enter_page_description_arabic') }}">{{ old('description_ar') }}</textarea>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div id="content-en-content" class="tab-content">
                ...
                <textarea id="content_en" name="content_en" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-gray-100" rows="10">{{ old('content_en') }}</textarea>
                @error('content_en')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div id="content-ar-content" class="tab-content hidden">
                ...
                <textarea id="content_ar" name="content_ar" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-gray-100" rows="10" dir="rtl">{{ old('content_ar') }}</textarea>
                @error('content_ar')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="meta_title_en" name="meta_title_en" value="{{ old('meta_title_en') }}" maxlength="60"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
                ...
                <div>
                    ...
                    <input type="text" id="meta_title_ar" name="meta_title_ar" value="{{ old('meta_title_ar') }}" maxlength="60" dir="rtl"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white"
...
document.getElementById('name_en').addEventListener('input', function() {
    // This could be used to auto-generate slug if needed
});
